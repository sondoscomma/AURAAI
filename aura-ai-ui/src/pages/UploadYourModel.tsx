...
export default function UploadYourModel(): JSX.Element {
  ...
  const activeStep = resultImage ? 4 : 3;
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "14px",
                  border: isDragging
                    ? "1.5px solid rgba(198,166,247,0.7)"
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!isGenerating) {
                    e.currentTarget.style.boxShadow = "0 8px 32px rgba(198,166,247,0.35)";
            ...
            >
              ...
              >
                {resultImage ? "⬇ Download Generated Image" : "Download Generated Image"}
              </button>
            </section>
          </div>
        </main>
